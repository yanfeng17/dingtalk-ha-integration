"""Sensor platform for DingTalk Gateway integration."""
...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry, async_add_entities) -> None:
    """Set up DingTalk Gateway sensor from a config entry."""
    entity = DingTalkLastMessageSensor(entry.entry_id)
...
class DingTalkLastMessageSensor(SensorEntity):
    """Sensor showing the last received message from DingTalk."""
    ...
    def __init__(self, entry_id: str) -> None:
        ...
        self._attr_name = "DingTalk Last Message"
        self._attr_icon = "mdi:message-text"
        self._attr_native_value = "等待消息..."
